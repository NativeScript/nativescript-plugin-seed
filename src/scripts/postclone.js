...
var class_name,
    ...
    filesToReplace = {
        readmeFile: { name: "README.md", location: "../README.md"},
        travisFile: { name: ".travis.yml", location: "../.travis.yml"}
    };
...
function replaceFiles() {
    ...
    for(key in filesToReplace){
        ...
        var contents = fs.readFileSync(file.name);
        fs.writeFileSync(file.location, contents);
